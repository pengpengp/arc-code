...
# arc-code installer
# Usage: curl -fsSL https://raw.githubusercontent.com/paoloanzn/arc-code/main/install.sh | bash
...
REPO="https://github.com/paoloanzn/arc-code.git"
INSTALL_DIR="$HOME/arc-code"
...
build_binary() {
  info "Building arc-code (all experimental features enabled)..."
  cd "$INSTALL_DIR"
...
link_binary() {
  ...
  ln -sf "$INSTALL_DIR/cli-dev" "$link_dir/arc-code"
  ok "Symlinked: $link_dir/arc-code"
...
printf "    ${CYAN}arc-code${RESET}                          # interactive REPL\n"
printf "    ${CYAN}arc-code -p \"your prompt\"${RESET}          # one-shot mode\n"
echo ""
printf "  ${BOLD}Set your API key:${RESET}\n"
printf "    ${CYAN}export ANTHROPIC_API_KEY=\"sk-ant-...\"${RESET}\n"
echo ""
printf "  ${BOLD}Or log in with Claude.ai:${RESET}\n"
printf "    ${CYAN}arc-code /login${RESET}\n"
echo ""
printf "  ${DIM}Source: $INSTALL_DIR${RESET}\n"
printf "  ${DIM}Binary: $INSTALL_DIR/cli-dev${RESET}\n"
printf "  ${DIM}Link:   ~/.local/bin/arc-code${RESET}\n"
echo ""
