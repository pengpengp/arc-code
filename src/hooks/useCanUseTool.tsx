          ...
          case "deny":
            {
              ...
              if (feature("TRANSCRIPT_CLASSIFIER") && result.decisionReason?.type === "classifier" && result.decisionReason.classifier === "auto-mode") {
                ...
                toolUseContext.addNotification?.({
                  ...
                  priority: "immediate",
                  jsx: <><Text color="error">{(typeof tool.userFacingName === 'function' ? tool.userFacingName(input) : tool.name).toLowerCase()} denied by auto mode</Text><Text dimColor={true}> · /permissions</Text></>
                });
              }
              resolve(result);
              return;
