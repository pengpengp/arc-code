<p align="center">
  <img src="assets/screenshot.png" alt="arc-code" width="720" />
</p>

<h1 align="center">arc-code</h1>
...
<p align="center">
  ...
  <a href="https://github.com/paoloanzn/arc-code/stargazers"><img src="https://img.shields.io/github/stars/paoloanzn/arc-code?style=flat-square" alt="Stars" /></a>
  <a href="https://github.com/paoloanzn/arc-code/issues"><img src="https://img.shields.io/github/issues/paoloanzn/arc-code?style=flat-square" alt="Issues" /></a>
  <a href="https://github.com/paoloanzn/arc-code/blob/main/FEATURES.md"><img src="https://img.shields.io/badge/features-88%20flags-orange?style=flat-square" alt="Feature Flags" /></a>
...
```bash
curl -fsSL https://raw.githubusercontent.com/paoloanzn/arc-code/main/install.sh | bash
```

Checks your system, installs Bun if needed, clones the repo, builds with all experimental features enabled, and symlinks `arc-code` on your PATH.

Then run `arc-code` and use the `/login` command to authenticate with your preferred model provider.
...
arc-code supports **five API providers** out of the box. Set the corresponding environment variable to switch providers -- no code changes needed.
...
```bash
git clone https://github.com/paoloanzn/arc-code.git
cd arc-code
bun build
./cli
```
